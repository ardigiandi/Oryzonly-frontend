    ...
    return (
        <div className="flex flex-col mt-24">
            ...
            <div className='flex flex-col lg:flex-row justify-center gap-x-5 gap-y-5 px-6 mt-12'>
                {Cardlist.map((list) => (
                    <>
                        <div key={list.title} className="flex flex-col gap-y-6 border-2 rounded-xl px-5 py-5">
                            <Image src={list.image} alt="" className="w-[350px]" priority={true} width={355} height={200} />
                            <div
                            ...
                            >
                                ...
                                <p className="text-sm text-gray-500 tracking-[-0.7px]">{list.price}</p>
                            </div>
                            <a
                                href=""
