...
export default function Registerviews() {
    ...
    return (
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row justify-between my-[50px] lg:my-[120px] gap-x-[150px] px-5 lg:px-0">
            <Image src="/register.png" width={500} height={600} alt={"register"} className="hidden lg:block" />
            <div className="flex flex-col">
                ...
                <form onSubmit={handlerRegister} className="flex flex-col gap-y-5 mt-12">
                    <div className="flex flex-col gap-y-2">
                        <label htmlFor="" className="text-base text-navy font-semibold">Full Name</label>
                        <div className="flex flex-row gap-x-2 border-2 rounded-md py-[14px] px-4">
                            ...
                            <input type="text" placeholder="enter your name.." className="w-full focus:outline-none" value={inputValue} onChange={handleInputChange} />
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-y-2">
                        ...
                        <div className="flex flex-row gap-x-2 border-2 rounded-md py-[14px] px-4">
                            ...
                            <input type="email" placeholder="cth: example@email.com" className="focus:outline-none w-full"
                            />
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-y-2">
                        ...
                        <div className="flex flex-row gap-x-2 border-2 rounded-md py-[14px] px-4">
                            ...
                            <input onChange={(password) => setPassword(password.target.value)} type={passwordVisible ? "text" : "password"} placeholder="enter your password " className="w-full focus:outline-none" />
